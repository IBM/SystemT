...
/**
 * Function that takes a span as argument and returns its BEGIN attribute as an integer.
 * 
 */
public class GetBegin extends ScalarFunc {
  public static final String[] ARG_NAMES = {"span"};
  public static final FieldType[] ARG_TYPES = {FieldType.SPAN_TYPE};
  public static final String[] ARG_DESCRIPTIONS = {"span to find the begin offset of"};
   ...
   */
  public GetBegin(Token origTok, AQLFunc[] args) throws ParseException {
    super(origTok, args);
  }

  /** Convenience constructor for creating a function call directly. */
  public GetBegin(ScalarFunc arg) {
