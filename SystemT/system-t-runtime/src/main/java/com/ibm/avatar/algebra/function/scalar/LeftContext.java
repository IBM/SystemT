...
/**
 * Builds a new annotation whose span covers the span of text to the left of the indicated span in
 * the original text. Second argument is an integer that tells how many characters of context to
 * capture.
 * 
 */
public class LeftContext extends ScalarFunc {
   ...
   */
  public LeftContext(Token origTok, AQLFunc[] args) throws ParseException {
    super(origTok, args);
  }
  ...
  public Object reallyEvaluate(Tuple t, TupleList[] locatorArgs, MemoizationTable mt,
    ...
    int begin = Math.max(0, end - chars);
