...
public class Token implements Serializable {
  ...
  /**
   * Makes a deep copy of this token without links to other tokens, so that this token can be used
   * for error messages without pulling along every other token with it.
   * 
   * @return a deep copy of this token
   */
  public Token copy() {
    Token tokenCopy = newToken(this.kind, this.image);

    tokenCopy.beginLine = this.beginLine;
    tokenCopy.beginColumn = this.beginColumn;
    tokenCopy.endLine = this.endLine;
    tokenCopy.endColumn = this.endColumn;
   ...
   * subclass objects using the value of of Kind. Simply add the cases to the switch for all those
...
/* JavaCC - OriginalChecksum=4e4b686fd57e6044cc9efbbcfd378143 (do not edit this line) */
