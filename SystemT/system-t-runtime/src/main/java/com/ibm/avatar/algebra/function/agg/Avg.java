...
public class Avg extends AggFunc {
  ...
  public Object evaluate(TupleList tupleList, TupleList[] locatorArgs, MemoizationTable mt)
    ...
    // return null if all tuples are null
    if (nonNullTuples == 0) {
      return null;
    } else {
      return sum / nonNullTuples;
    }
  }
  ...
  public FieldType returnType() throws FunctionCallValidationException {
    // By convention, the average is a floating-point value even if the input is an integer.
